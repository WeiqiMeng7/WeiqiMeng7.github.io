...
6. 如果出现使用git更新时报错：Build failed because it uses a deprecated version of `actions/upload-artifact: v3`

   (可以参考某blog中方法修改文件内容（If it were me, I’d try to upgrade everything and see what happens. In .github/workflows/gh-pages.yml…），[vpn](https://discourse.gohugo.io/t/build-failed-because-it-uses-a-deprecated-version-of-actions-upload-artifact-v3)依次修改即可解决问题)
...
可供参考的学术主页：
- [澳门大学惠老师](https://huihongxun.github.io/)
- [MIT开发者](https://rjzupkoii.github.io//)
